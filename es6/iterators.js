...
//let personsIron = personsList.map((person)=>person.savedby === "IronMan" ? person.name : "").filter(p=>p!="")
let personsIron = personsList.map((person)=>person.savedby === "IronMan" ? {
                                               "Good Name ": person.name +" Brave"} : "").filter(p=>p!="")
//console.log(personsIron)
//console.log(personsList);
